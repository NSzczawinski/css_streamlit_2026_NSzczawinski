...
if menu == "Researcher Profile":
    ...
    st.write("""
    This work detailed the creation of a univariate distribution generator in the R language.
    Distributions were generated by training a primitive neural network to learn the characteristic function of a target distribution.
    The purpose of such a generator is to reconstruct the distribution of data for the purposes of producing samples.
    """)
