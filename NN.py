...
NN(random_seed = False,
   samples_count = 5000,
   frequencies_count = 100,
   dimension = 2,
   topology = [300, 50, 2],
   activations = ["sin", "sin", "purelin"],
   batchsize = "fullbatch",
   resample_factor = 100,
   lr = 0.001,
   passes = 10000,
   loss = "SEL+",
   loss_lambda_parameter = 1,
   # characteristic_function = "eq_MNIG_mixture",
   # params = [
            # [0, 0],
            # [-1, 1],
            # [[5, 0.5],
            ...
            # 1
            # ],
   # characteristic_function = "mvnormal",
   # params = [
            # [10, 10],
            # [[5, 0.7],
             # [0.7, 10]]
            # ],
   characteristic_function = "mvnormal_mix",
   params = [
            [5, 5],
            [[5, 3],
             [3, 10]],
